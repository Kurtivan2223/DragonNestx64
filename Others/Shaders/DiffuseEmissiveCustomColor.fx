...
float4 g_CustomColor : CUSTOMCOLOR
<
    string UIName = "Custom Color";
> = { 1.0f, 1.0f, 1.0f, 1.0f};

float4 g_CustomColor2 : CUSTOMCOLOR2
<
    string UIName = "Custom Color2";
> = { 1.0f, 1.0f, 1.0f, 1.0f};
...
VertexOutput DiffuseCustomColorVS( VertexInput Input ) 
{
	VertexOutput Output;
...
VertexOutputShadow DiffuseCustomColorShadowVS( VertexInput Input ) 
{
...
VertexOutput DiffuseCustomColorAniVS( VertexInputAni Input )
{
	VertexOutput Output;
...
VertexOutputShadow DiffuseCustomColorAniShadowVS( VertexInputAni Input )
{
	VertexOutputShadow Output;
...
float4 CalcDiffuseColor( VertexOutput Input )
{
	...
	DiffuseTex.xyz = lerp( DiffuseTex.xyz, g_CustomColor.xyz * DiffuseTex.xyz, MaskTex.a );
	DiffuseTex.xyz = lerp( DiffuseTex.xyz, g_CustomColor2.xyz * DiffuseTex.xyz, MaskTex.b );
...
PixelOutput DiffuseCustomColorPS( VertexOutput Input )
{
	PixelOutput Output;
...
PixelOutput DiffuseCustomColorShadowPS( VertexOutputShadow Input )
{
	PixelOutput Output;
...
technique DiffuseTech
{
    pass p0 
    {		
		VertexShader = compile vs_2_0 DiffuseCustomColorVS();
		PixelShader  = compile ps_2_0 DiffuseCustomColorPS();
    }
}
technique DiffuseAniTech
{
    pass p0 
    {		
		VertexShader = compile vs_2_0 DiffuseCustomColorAniVS();
		PixelShader  = compile ps_2_0 DiffuseCustomColorPS();
    }
}
technique DiffuseShadowTech
{
    pass p0 
    {		
		VertexShader = compile vs_2_0 DiffuseCustomColorShadowVS();
		PixelShader  = compile ps_2_0 DiffuseCustomColorShadowPS();
    }
}
technique DiffuseAniShadowTech
{
    pass p0 
    {		
		VertexShader = compile vs_2_0 DiffuseCustomColorAniShadowVS();
		PixelShader  = compile ps_2_0 DiffuseCustomColorShadowPS();
    }
}
#else
